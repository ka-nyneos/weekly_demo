        ...
        <div className="p-4 border-b">
          <h4 className="text-lg font-semibold text-gray-800 flex items-center justify-between">
            ...
            <span className="text-sm font-normal text-gray-500">
              Total: {table.getCoreRowModel().rows.length} requests
            </span>
          </h4>
        </div>
                ...
                <tr>
                  ...
                  >
                    <div className="flex flex-col items-center">
                      ...
                      <p className="text-lg font-medium text-gray-900 mb-1">No exposure requests found</p>
                      <p className="text-sm text-gray-500">There are no pending exposure requests at the moment.</p>
                    </div>
                  </td>
                </tr>
              ) : (
